...
module.exports = class SupportCommand extends commando.Command {
  constructor(client) {
    super(client, {
      ...
      description: 'SyncSBot Destek Ekibi ile görüşmeye bağlanırsınız.',
      details: oneLine `
               SyncSBot ile ilgili yardıma ihtiyacınız var mı?
  ...
  async run(message) {
    ...
    message.reply(`${this.client.emojis.get('464406478153973770')} SyncSBot Desteği ile iletişim kurduğunuz için teşekkür ederiz! Herhangi bir destek yetkilisi varsa, yakında sizinle iletişim kuracaktır.`)
    let chan = message.channel
    let supportChan = '486884339934691329'
    const embed = new RichEmbed()
      ...
      .setFooter('SyncSBot canlı-destek sistemi')
      .setTimestamp()
		this.client.channels.get(supportChan).send('<@&486884339934691329>')
